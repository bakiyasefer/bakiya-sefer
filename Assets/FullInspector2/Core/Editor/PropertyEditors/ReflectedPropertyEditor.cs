...
namespace FullInspector.Internal {
    ...
    internal class ReflectedPropertyEditor : IPropertyEditor, IPropertyEditorEditAPI {
        ...
        private static bool ShouldShowMemberDynamic(object element, MemberInfo member) {
            ...
            if (showIf != null) {
                return fiReflectionUtility.GetBooleanReflectedMember(element.GetType(), element, showIf.ConditionalMemberName, /*defaultValue:*/true);
            }
            if (hideIf != null) {
                return !fiReflectionUtility.GetBooleanReflectedMember(element.GetType(), element, hideIf.ConditionalMemberName, /*defaultValue:*/true);
            }
