...
namespace FullInspector.Internal {
    // TODO: let's have users write a custom AttributeBasedPropertyEditor instead of using the standard IPropertyEditor setup
    //       we can make it more flexible by adding more dynamic controls, ie, a child editor can dynamically indent the content
