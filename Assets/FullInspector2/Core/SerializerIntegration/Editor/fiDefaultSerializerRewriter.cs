...
namespace FullInspector.Internal {
    ...
    public static class fiDefaultSerializerRewriter {
        ...
        private static string OutputNetworkBehaviorPath = fiUtility.CombinePaths(fiSettings.RootGeneratedDirectory, "BaseNetworkBehavior.cs");
        ...
        private static void GenerateDefaultBehaviors(string serializerType) {
            ...
            Append(builder, "//          selection wizard. It will be overwritten if you change your selected serializers.");
            Append(builder);
            Append(builder, "#if !(UNITY_4_3 || UNITY_4_5 || UNITY_4_6 || UNITY_5_3)");
            Append(builder, "namespace FullInspector {");
            Append(builder, "    public abstract class BaseNetworkBehavior : BaseNetworkBehavior<" + serializerType + "> {}");
            Append(builder, "}");
            Append(builder, "#endif");
            File.WriteAllText(OutputNetworkBehaviorPath, builder.ToString());
